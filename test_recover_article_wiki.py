from Program import recover_article_wiki as script
import requests
class TestArticle:
...
class MockResponse :
    ...
    @staticmethod
    def json():
        return {"query": {"searchinfo": {"totalhits": 819}, "search": [{"ns": 0, "title": "Rue de Rivoli","pageid": 105972,"size": 65788,},{"pageid": '55656'}]}}
...
class MockResponse2 :
    ...
    @staticmethod
    def json():
        return {"query": {"pages": {"5653202": {"pageid": 5653202,"ns": 0,"title": "Cité Paradis", "extract": "ARTICLE: BLABLABLA"}}}}
